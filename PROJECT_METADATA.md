...
## Primary Domain
Bioinformatics / Genetic Data Science

## Core Capabilities
- Upload FASTQ and run sequential analysis pipeline
- Stream stage-by-stage NDJSON responses
- Fetch FASTQ from direct URL or ENA accession
